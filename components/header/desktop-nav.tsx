                  ...
                  {navItem.subMenu.map((subItem) => (
                    <li key={subItem.label} className="relative group/submenu">
                      <Link
                        href={
                          isProducts
                            ? `/products?category=${encodeURIComponent(subItem.label.toLowerCase())}`
                            : subItem.href
                        }
                            ...
                            {subItem.subSubMenu.map((subSubItem) => (
                              <li key={subSubItem.label}>
                                <Link
                                  href={
                                    isProducts
                                      ? `/products?category=${encodeURIComponent(subItem.label.toLowerCase())}&subcategory=${encodeURIComponent(subSubItem.label.toLowerCase())}`
                                      : subSubItem.href
                                  }
